...
[Api Versioning / File Structuring](#api-versioning---file-structuring)

[Flow Of Data](#flow-of-data)

### ***Must Read Documentation Atleast Once*** ###

Your can find almost every solution you need in documentation only.  
Easy to read and one of the best docs.
...
***But be mindfull of not putting every thing in model put only things which will repeat a lot.*** 
...
### **Business logic should be in service/trait class**
...
### **Api Versioning - File Structuring**

Implement api versioning for Controller, Validations, ApiResource.
...
routes -> controller -> validation -> policy -> CRUD (operations) -> response
